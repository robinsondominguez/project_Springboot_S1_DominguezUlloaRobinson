...
INSERT IGNORE INTO movimientos (fecha, tipo_movimiento, usuario_id, bodega_origen_id, bodega_destino_id) VALUES
...
INSERT IGNORE INTO detalle_movimientos (movimiento_id, producto_id, cantidad) VALUES
(1, 1, 10),
(1, 2, 20),
(2, 3, 5),
(3, 1, 3);
...
INSERT IGNORE INTO auditoria (operacion, fecha, usuario, entidad, valor_anterior, valor_nuevo) VALUES
